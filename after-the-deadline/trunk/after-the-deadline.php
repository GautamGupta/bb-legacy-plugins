...
AtD.rpc = '".ATD_PLUGPATH."check.php?url=';\n";
		if($atd_plugopts['key']){
...
/* Add Actions:
 * (1) Hook 'post_form_pre_post' to 'atd_button' - Inserts (echoes) AtD Spell Check Button (actually, Link) when called, should be after anything
 * (2) Hook 'bb_head' to 'atd_css_js' - Enqueues & Prints Script and Style (JS & CSS)
 * (3) Hook 'bb_admin_menu_generator' to 'atd_menu_link' - Adds a menu link to After the Deadline setting's page
