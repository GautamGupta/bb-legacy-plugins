...
<table class="form-table">
	...
	<tr>
		<td colspan="2">
			<input type="checkbox" id="atd_autoproofread" name="atd_autoproofread" value="1" <?php if ( $autoproofread == 1 ) { ?>checked="checked"<?php } ?>> <label for="atd_autoproofread"><?php _e( 'Automatically proofread content when I forget to do a spellcheck', 'after-the-deadline' ); ?></label>
		</td>
	</tr>
	<?php
	}
	...
	<tr>
		<th scope="row">
			<label><?php _e( 'Enable proofreading for the following grammar and style rules when writing posts and pages:', 'after-the-deadline' ); ?></label>
		</th>
		<td>
			<p><?php
	...
	<tr>
		<th scope="row">
			<label for="atd_ignored_phrases"><?php _e( 'Ignored Phrases', 'after-the-deadline' ); ?></label>
		</th>
		<td colspan="2">
