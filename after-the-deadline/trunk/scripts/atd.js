...
jQuery(document).ready(function(){
    jQuery("#post_content").before('<div style="clear:both;"></div><span class="atd_container"><img src="'+AtD.plugpath+'images/atdbuttontr.gif"><a href="#postform" id="checkLink">Check Spelling</a></span><div style="clear:both;"></div>');
    jQuery("#checkLink").click(function() {
        jQuery("#checkLink").click(disableClick);
        AtD.checkTextArea('post_content', 'checkLink', 'Edit Text');
        /*Use below if above doesn't work, for some reason*/
...
var AtD = 
{
   plugpath : 'http://www.domain.tld/forums/my-plugins/after-the-deadline/',
...
AtD._checkTextArea = function(id, commChannel, linkId, after)
{
   ...
   else
   {
       ...
       jQuery('#' + id).css( { 'overflow' : 'auto', 'clear' : 'both' } );
       jQuery('#' + id).height( options['height'] );
       commChannel(id,
       {
