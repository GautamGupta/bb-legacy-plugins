...
function check()
{
    jQuery(function()
    {
        ...
        else 
        {
            ...
            jQuery('#post_content').replaceWith('<div class="input" id="post_content" class="post_content">' + jQuery('#post_content').val() + '</div>');
...
var AtD = 
{
   ...
   // nothing should be ignored, you can ignore something by uncomment the above line and checking what all needs to be ignored
