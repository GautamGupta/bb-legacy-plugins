...
Allows users to upload an avatar (gif, jpeg/jpg or png) image to bbPress. Admins can configure maximum allowed file size and image dimensions.  Includes fel64's code for 'Identicons' - default avatars made of abstract patterns based on the user's email address.

This is a branch of Avatar Upload version 0.4.1.
...
5. Upload the plugin files to the following locations.
   ...
   `my-plugins/identicon.php`        - your `my-plugins/` dir (and activated).
...
== Change Log ==
2007-06-16 ver. 0.4.1b branch to include Identicons as avatar option.
