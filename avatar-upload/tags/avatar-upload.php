...
// Content types -- more stingent check on file types.
...
// Do not let users upload and avatar if user is a bozo OR user id not equal to current user's id
...
$errorcodes = array(
	...
	"The image file is too big, the maximum filesize allowed is $max_kbytes KB.",
	"The image file is too big, the maximum filesize allowed is $max_kbytes KB.",
...
{
	$current_avatar = get_avatar($user_id); // for comparison later
