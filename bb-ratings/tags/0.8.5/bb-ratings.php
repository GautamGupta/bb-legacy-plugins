...
function bb_get_rating_plugin_version() { return '0.8.5'; }
...
function bb_do_rating() {
	...
	bb_enqueue_script( 'bb_rating', bb_path_to_url( dirname(__FILE__) . '/bb-ratings.js' ), array('wp-ajax', 'add-load-event'), bb_get_rating_plugin_version() );
