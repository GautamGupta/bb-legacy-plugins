...
<p>
	<label for="report_reason"><?php _e('What is your reason for reporting this post?'); ?>
...
<p>
	<label for="report_content"><?php _e('Please give more information: (Plain text only, no HTML allowed.)'); ?>
		<textarea name="report_content" cols="50" rows="8" id="report_content" tabindex="2"></textarea>
	</label>
</p>
<p class="submit">
  <input type="submit" id="postformsub" name="Submit" value="<?php echo attribute_escape( __('Send Report &raquo;') ); ?>" tabindex="3" />
</p>
