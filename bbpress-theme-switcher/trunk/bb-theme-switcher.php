...
echo '<div style="position:relative;clear:both;padding-right:1em;white-space:nowrap;text-align:right;">'.__('Theme Switcher').': ';bb_theme_switcher('dropdown'); echo '</div>';
}
return $template;	
} 
