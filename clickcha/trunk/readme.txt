...
[Click here](http://bbpress.demo.clickcha.com/register.php "Clickcha Demo") to see Clickcha in action.
...
1. Upload `clickcha.php` to the `/my-plugins/` directory (you might have to create this directory)
2. Activate the plugin through the 'Plugins' menu in bbPress
3. Go to Clickcha settings in the bbPress admin to set your API keys (you can get your free API keys on the same page)
...
Yes, Clickcha plugin for bbPress does require Javascript (we might add an option to make it work without Javascript in the future).
...
Not at the moment but multi-language support will be added soon. If you wish to help with the translations please write to developer at clickcha.com.
...
1. Clickcha screenshot ([Try the live demo](http://bbpress.demo.clickcha.com/register.php "Clickcha Demo"))