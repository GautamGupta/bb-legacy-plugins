...
1.  	PROBLEM:  In admin user interface, you have to press submit twice to get the input fields to reflect the actual changes you made.  
...
2.  	PROBLEM:  Would like a more efficient way to choose and enter allowed users.  
