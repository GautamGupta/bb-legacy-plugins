...
/*
HTTP authentication for bbPress version 0.1.1
...
function http_add_admin_page() {
	...
	$bb_submenu['site.php'][] = array(__('HTTP authentication'), 'use_keys', 'http_admin_page');
}
...
if ($HTTP_enabled) {
	...
	add_action( 'bb_got_roles', 'bb_login' );
}
?>