...
Note: this plugin is not thoroughly tested, consider it to be beta
grade software at best.

== License ==

HTTP authentication for bbPress version 0.1.3
...
* 0.1.3 :
  <br/>Workaround for bbPress bug 670 - http://trac.bbpress.org/ticket/670