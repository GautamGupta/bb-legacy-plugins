...
if (human_register_page()) :  //  only display on register.php and hide on profile page
	...
	$compare=$_SESSION['HUMAN_TEST'];	// localize session once for speed
	...
	echo '</th><td align=left><input name="human_test" type="text" id="human_test" size="30" maxlength="140" value="" />';	// answer field
