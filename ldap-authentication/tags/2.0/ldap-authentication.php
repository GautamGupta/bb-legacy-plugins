...
class LDAP_Authentication
{
	 ...
	 * @author Sam Bauers
	 **/
	private function locationIs($page)
	{
		$names = array(
			$_SERVER['PHP_SELF'],
	 ...
	 * @author Sam Bauers
	 **/
	public function disableLDAPpasswordRecovery()
	{
	 ...
	 * @author Sam Bauers
	 **/
	public function disableLDAPpasswordEditing()
	{
	 ...
	 * @author Sam Bauers
	 **/
	public function removePasswordCapability($allcaps, $caps)
	{
	 ...
	 * @author Sam Bauers
	 **/
	public function checkLogin($user, $pass, $already_md5 = false)
	{
		global $bbdb;
	 ...
	 * @author Sam Bauers
	 **/
	private function connectUser($user, $pass, $register = false)
	{
		if ($this->server['port']) {
	 ...
	 * @author Sam Bauers
	 **/
	private function newUser($user_login, $user_pass, $user_email)
	{
		global $bbdb;
