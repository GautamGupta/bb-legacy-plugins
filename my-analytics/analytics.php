...
Description: Add Google Analytics to BBPress. It is based on Askimet code and can be used as demonstration. This plugin is made for demonstration.<br/> I invite you to install mySEO. 
Author: Thierry HUET
Version: 0.2
...
add_action('bb_foot', 'ap_add_analytics');
