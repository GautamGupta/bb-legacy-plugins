...
// limit *3 is a lazy work around to avoid a join, as topic_static=0 in next query filters out deleted
$most_views = $bbdb->get_results("SELECT topic_id FROM $bbdb->topicmeta WHERE meta_key='views' ORDER BY cast(meta_value as UNSIGNED) $sort LIMIT ".$limit*3);
