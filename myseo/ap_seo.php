...
Description: Add keywords to be identified by all SEO browsers. It is based on <a href="http://www.woorank.com">Woorank website</a> analysis tools and solve only "In-Site" SEO.<br/> You want to do something for me... Go on my <strong><a href='http://www.aperto-nota.fr'>web page</a></strong> and click on the ads.
Author: Thierry HUET
Version: 0.3
...
function ap_seo_configuration_page()
{
	...
	Before saving, go to <a href="http://www.woorank.com">Woorank</a> or another website analysys tool like that to estimate tour progress.
...
function ap_add_seo()
{
	...
	// -- Code SEO --------------------
	$mycode  = "<!-- Implantation du code SEO/Woorank (c) http://www.aperto-nota.fr --->\n" ;
	$mycode .= "\t<link rel='pingback' href='http://www.aperto-nota.fr/xmlrpc.php' />\n" ;
