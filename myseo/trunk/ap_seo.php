...
Description: Add keywords to be identified by all SEO browsers. It is based on <a href="http://www.woorank.com">Woorank website</a> analysis tools and solve only "In-Site" SEO.<br/> You want to do something for me... Go on my <strong><a href='http://www.aperto-nota.fr'>web page</a></strong> and click on the ads.<br/> I need more feedback. Vote and let me a message if you are using my plugin.<br/><br/> Thanks
Author: Thierry HUET
Version: 1.1
...
*/
	...
	'seo_wot' => array(
		'title' => __( 'myWOT Key'),
		'class' => 'long',
		'note' => __( 'If you don\'t have a meta tag, please go to <a href="%s">myWot.com</a>'),
	),	
	'seo_woorank' => array(
