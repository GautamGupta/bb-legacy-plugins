...
/*
Plugin Name: MySEO
Plugin URI: http://www.aperto-nota.fr
Description: Add keywords to be identified by all SEO browsers. It is based on <a href="http://www.woorank.com">Woorank website</a> analysis tools and solve only "In-Site" SEO.
Author: Thierry HUET
Version: 0.0
...
function ap_add_seo()
{
	...
	// -- Code SEO --------------------
	$mycode  = "<!-- Implantation du code SEO/Woorank --->\n" ;
