...
* changed how update/restore functions read and write files, to improve performances

= Version 3.4 (2010-04-20) =
...
= Version 3.4.0.2 (2010-04-27) =

* updated installation instructions: a mandatory edit was missing... Pretty sure the plugin will work from now on! =)