...
* trailing slash redirect added to almost all `.htaccess` rules

* now using `bb_get_forum()` instead of deprecated `get_forum()`

= Version 5.0.5 (2010-11-01) =

* bug with <a href="http://bbpress.org/plugins/topic/bbpm/">bbPM plugin</a> fixed

= Version 5.0.4 (2010-09-20) =

* bug with files displaying in subfolders (e.g., <a href="http://bbpress.org/plugins/topic/avatar-upload/">Avatar Upload</a> plugin's images) fixed
