...
Unzip the file and copy the page-links.php file, the page-links.css
file and the page-links-background.gif image into the my-plugins
directory.
...
* 1.0 :
  <br />Initial Release
* 1.0.1 :
  <br />Fixed a bug relating to earlier versions, suppressed a PHP warning
* 1.0.2 :
