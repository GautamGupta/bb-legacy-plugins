...
* 0.1.7 :
  ...
  <br />Replaced call to bb_get_plugin_data() with custom call that does not
        use file()
* 0.1.8 :
  <br />Cleaned up sloppy function call
* 0.1.9 :
  <br />Pass the contents index of plugin_file array instead of the whole
        array
* 0.1.10 :
  <br />0.1.9 was all talk and no action, this time for sure
* 0.1.11 :
  <br />Clear readme.txt link properly on each loop through the plugin list
        items
* 0.1.12 :
  <br />Reinstate author link when there is no author uri