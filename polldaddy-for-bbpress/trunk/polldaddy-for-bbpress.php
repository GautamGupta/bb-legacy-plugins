...
<form class="settings" method="post" action="<?php bb_uri('bb-admin/admin-base.php', array('plugin' => 'bb_polldaddy_admin_page'), BB_URI_CONTEXT_FORM_ACTION + BB_URI_CONTEXT_BB_ADMIN); ?>">
	<fieldset>
