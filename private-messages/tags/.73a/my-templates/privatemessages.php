...
<tr<?php topic_class(); ?>>
	<td><?php if($pm->seen == 0) { echo "<img src=\"./my-templates/newmail.png\" align=\"top\" />"; } ?><?php echo " <a href=\"".bb_get_pm_link('?id='.$pm->pm_id)."\">".$pm->pmtitle."</a>"; ?></td>
...
<tr<?php topic_class(); ?>>
	<td><?php if($sentpm->seen == 0) { echo "<img src=\"./my-templates/newmail.png\" align=\"top\" />"; } ?><?php echo " <a href=\"".bb_get_pm_link('?id='.$sentpm->pm_id)."\">".$sentpm->pmtitle."</a>"; ?></td>
