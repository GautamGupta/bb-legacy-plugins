...
Version History:
1.0		: Initial Release
2.0		: Complete re-write. Added blacklist functionality and admin page. Domains can now optionally be specified with wildcards.
*/


/**
 * Restrict registration for bbPress version 2.0
 * 
 * ----------------------------------------------------------------------------------
 * 
...
class Restrict_Registration
{
	 ...
	 * @author Sam Bauers
	 **/
	private function removeWhiteFromBlack()
	{
	 ...
	 * @author Sam Bauers
	 **/
	private function evaluate($list)
	{
	...
	/**
	 * Creates a cleaned string representing the whitelist and inserts it into bbPresses $profile_info_keys global
	 *
	 * @return array
	 * @author Sam Bauers
	 **/
	public function getWhitelist($profile_info_keys)
	{
...
function restrict_registration_admin_page_add()
{
	...
	if (isset($bb_submenu['plugins.php'])) {
		$bb_submenu['plugins.php'][] = array(__('Restrict registration'), 'use_keys', 'restrict_registration_admin_page');
	} else {
		$bb_submenu['site.php'][] = array(__('Restrict registration'), 'use_keys', 'restrict_registration_admin_page');
	}
}
