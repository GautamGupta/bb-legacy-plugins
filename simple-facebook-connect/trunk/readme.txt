...
DEMO SITE: 
* http://moogie.idle.fi/bbpress-demo/
...
Prerequirements:
* PHP 5 (tested on 5.2 and 5.3)
* PHP CURL and JSON extensions (required by Facebook's PHP connector)
...
* In Facebook Application Settings, check that OAuth 2.0 is enabled (Advanced-tab)
* In Facebook Application Settings, add your sites domain name (domain.com if your site is www.domain.com) to 'Site Domain' field (Web Site-tab)
