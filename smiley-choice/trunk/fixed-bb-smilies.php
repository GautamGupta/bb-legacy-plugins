...
"FIXED" for Smiley Choose Plugin by Possessed, but big thx to _ck_
*/
...
add_action('bb_head','choose_smiley');
...
$pack=choose_smiley();
$bb_smilies['icon_set']=$pack;  // change this to the exact directory name (case sensitive) if you want to switch icon package sets
