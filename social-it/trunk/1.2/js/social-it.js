...
jQuery('#shortyapichk-snip').click(function() {
	if (this.checked) {
		this.checked=jQuery('#shortyapidiv-snip').fadeIn('fast');
	}
	else {
		jQuery('#shortyapidiv-snip').fadeOut('fast');
	}
});
...
jQuery('#autocenter-space').click(function() {
	...
	jQuery('#custom-warning').fadeIn('fast');
});
