...
Social It adds a (X)HTML compliant list of social bookmarking icons to topics, front page, tags, feeds etc. See configuration panel for more settings.
It can add the following social bookmarks: Twitter, Digg, Delicious, StumpleUpon, Reddit, Diigo, YahooBuzz, Technorati, Mixx, Facebook, Myspace, DesignFloat, GoogleBookmarks, Blinklist, Script & Style, LinkedIn, Newsvine, Devmarks, Mister Wrong, Izeby, Tipd, Friendfeed, BlogMarks, Twittley. It can also display the feed URL of the current page you are on (If no feed URL is available, it uses the main feed URL). If you do not find your favourite bookmarking site here, please contact me.
Social It can also shorten the Permanent Links and offers a list of Short URL Services. You can choose any of those, and it will be used to shorten the URLs.
