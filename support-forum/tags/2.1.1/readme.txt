...
Tested up to: 1.0 alpha build 897
Stable tag: 2.1.1
...
* 2.1 :
  <br/>Compatibility with new bb_register_views/BB_Query methods introduced in build 876 for "unresolved" view
  <br/>Selection of individual forums as support forums rather than the whole site
* 2.1.1 :
  <br/>Add missing gettext calls to admin page to allow full internationalisation