...
/**
 * Support forum for bbPress version 2.1.1
 * 
 * ----------------------------------------------------------------------------------
 * 
...
?>
	...
	<form method="post">
		...
		<p>
			<?php _e('If you used support forum plugin version 1.0, you will need to update existing topics to work with 2.1'); ?>
		</p>
		<input name="action" type="hidden" value="support_forum_post_upgrade"/>
		<p class="submit"><input type="submit" name="submit_upgrade" value="<?php _e('Update topics to version 2.1'); ?>" /></p>
	</form>
<?php
}
