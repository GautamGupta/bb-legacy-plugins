...
?>
	...
	<ul class="notes">
		...
		<li>You may also enter just <code>/</code> to redirect to the website root (i.e. <code><?=bb_get_option('domain')."/"?></code>).</li>
	...
	<strong>Notes:</strong>
	<ul class="notes">
		<li>Allowed page address follows the rules above.
