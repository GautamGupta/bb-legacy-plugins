...
define('ZA_VISIBILITY_VERSION', '0.2');
...
<?php
	...
	<fieldset>
		...
		<p><?php _e('This is the list of all your forums. Please notice that a subforum inherit hide rules from its parent forum.', ZA_VI_ID) ?><p>
		<table class="widefat">
			<thead>
...
?>
	...
	<fieldset>
		<legend><?php _e('Edit Profiles', ZA_VI_ID) ?></legend><?php
			...
			$apl = "<a href=\"$pl\">$pl</a>";
			echo '<p>', sprintf(__('This is the list of those profiles that are hidden. <strong>All Profile Pages</strong> is a special entry that can be used to apply hide rules to all profile pages. If a single profile page has its own set of hide rules than only those rules are applied. You can handle the visibility of a profile through the link that you can find in the profile page (e.g. %s.)', ZA_VI_ID), $apl), '<p>';
?>
		<table class="widefat">
			<thead>
